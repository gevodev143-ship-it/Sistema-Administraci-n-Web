...
import BannerFerreteria from "../../modules/bannerferreteria/pages/bannerferreteriaPage";
import HistorialReclamosferreteriaPage from "../../modules/historialReclamosferreteria/pages/HistorialReclamosferreteriaPage";
...
export default function HistorialReclamosFerreteriaLayout() {
    ...
    return (
        <>
            <div>
                <NavBar_1/>
                <SideBar/>
                <HistorialReclamosferreteriaPage/>
